<?php session_start(); 
    ...
    $note1 = test_input($_POST['airbusNote1']);
    $note2 = test_input($_POST['airbusNote2']);
    $note3 = test_input($_POST['airbusNote3']);
    ...
    $resultat = $bdd->prepare("INSERT INTO news(title,note,entreprise,date) VALUES ('title', :note, 'airbus',CURRENT_TIMESTAMP)");
