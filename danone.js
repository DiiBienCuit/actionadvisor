...
function conseil(data){
    calculNote(data);
    var conseil = document.getElementById("conseil-danone");
    if(note<=4){
...
$.getJSON("https://newsapi.org/v2/everything?language=en&q=danone&from="+newsBeginDate+"&apiKey=468cf88b7d3a49dabe52086671bbb4ee", updateNews);
