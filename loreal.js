...
function conseil(data){
    calculNote(data);
    var conseil = document.getElementById("conseil-Loreal");
    if(note<=4){
...
$.getJSON("https://newsapi.org/v2/everything?language=en&q=l'oreal&from="+newsBeginDate+"&apiKey=468cf88b7d3a49dabe52086671bbb4ee", updateNews);
$.getJSON("https://www.quandl.com/api/v3/datasets/EURONEXT/OR.json?api_key=Zvxsyh15Zw6CniyvnpoL&start_date=2017-09-20&order=desc", addData);
